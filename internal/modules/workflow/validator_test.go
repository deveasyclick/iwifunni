...
func TestValidateDefinition(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "empty template id", definition: Definition{Trigger: valid.Trigger, Nodes: []Node{{ID: "delay_1", Type: WorkflowStepTypeDelay, Config: json.RawMessage(`{"duration":"5m"}`)}, {ID: "email_1", Type: WorkflowStepTypeNotification, Config: json.RawMessage(`{"template_id":"","channels":["email"]}`)}}, Edges: []Edge{{Source: "delay_1", Target: "email_1"}}}}, // wantErr = false — template_id is optional at definition time
		{name: "missing template id", definition: Definition{Trigger: valid.Trigger, Nodes: []Node{{ID: "delay_1", Type: WorkflowStepTypeDelay, Config: json.RawMessage(`{"duration":"5m"}`)}, {ID: "email_1", Type: WorkflowStepTypeNotification, Config: json.RawMessage(`{"channels":["email"]}`)}}, Edges: []Edge{{Source: "delay_1", Target: "email_1"}}}}, // wantErr = false
