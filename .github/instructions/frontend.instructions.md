...
- **Always run `pnpm build` after frontend changes.** Before finishing any frontend task, run the build to catch type errors, missing imports, and bundling issues. Fix any errors introduced by your changes before reporting done.
